...
class WPR_Register {
    ...
    function __construct( $formd_id, $singup_data ) {
        ...
        add_action( 'wpr_after_user_created', array($this, 'manage_user_verification'), 10);
    }
    ...
    function manage_user_verification($user_id) { 
        ...
        // handling manual verification
        if ( wpr_is_manual_verification_required() ) {
            update_user_meta($user_id ,'wpr_account_status' , 'inactive');
        }
